...
class TestChatLogging:
    def test_chat_writes_jsonl_log_entry(
        ...
        with (
            patch.object(llm_module, "chat_with_context", return_value="advice here"),
    ...
    def test_chat_succeeds_even_if_log_write_fails(
        self, in_memory_qdrant, mock_embedder, tmp_path
    ):
        ...
        with (
            patch.object(llm_module, "chat_with_context", return_value="good advice"),
            patch("routers.chat_router.settings") as mock_settings,
        ):
