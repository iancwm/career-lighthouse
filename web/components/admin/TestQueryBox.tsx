...
export default function TestQueryBox({}: Props) {
  ...
  return (
    <div className="mb-6">
      <h3 className="text-sm font-semibold text-gray-700 mb-1">Test Student Answer</h3>
      <p className="text-xs text-gray-500 mb-2">
        Try a student-style question to see which document excerpts the assistant would retrieve.
      </p>
      <form onSubmit={handleSubmit} className="flex gap-2 mb-3">
        <input
          ...
          placeholder="Example: What are DBS hiring requirements for internships?"
      ...
      {results !== null && (
        results.length === 0 ? (
          <p className="text-sm text-gray-400">
            No matching excerpts found. Check that the right documents have been uploaded and indexed.
          </p>
        ) : (
