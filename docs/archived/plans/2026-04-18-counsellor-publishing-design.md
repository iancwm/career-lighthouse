...
### 2. Frontend UX
- **Landing Page:** Large, high-priority textarea for input ("Paste your meeting notes, alumni summary, or research here...").
- **Session View:** Once analyzed, displays a sequence of review cards.
- **Resilience:** If the user closes the tab, they return to their active session(s) in an "In-Progress" list.
- **Observability:** Admin dashboard displays active sessions by user/counsellor.
...
2. **Frontend:** Build the "Research Landing" page and the "Review Session" sequence.
