...
- The YAML rebuild tool has shipped in `api/tools/ontology_rebuild.py`: it detects legacy YAML families, uses isolated direct Claude calls, and writes review bundles without importing into canonical stores. P0 egress/output-safety hardening shipped in v0.2.0.0; the investment-banking pilot and answers workflow remain open in `TODOS.md`.
