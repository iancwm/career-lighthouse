...
| `api/services/ontology_extraction.py` | New | Stage 1 (mentions + offsets), Stage 2 (resolution), Stage 3 (claim extraction), Stage 4 (verification) |
...
## 6. Immediate next step after this document
